...
class _TodoUiScreenState extends State<TodoUiScreen> {
  ...
  void getData() async {
    ...
    todoCardsList.clear(); // Clear list before adding to avoid duplicates
  ...
  void submit(bool doEdit, [TodoModel? obj]) async {
    if (titleController.text.isNotEmpty &&
      ...
      if (doEdit) {
        ...
        await TodoDatabase().updateTodoItem(mapObj);
        clearController();
        getData(); // Refresh data from database
        ...
        await TodoDatabase().insertTodoItem(dataMap);
        clearController();
        getData(); // Refresh data from database
        // Show success message
        ScaffoldMessenger.of(context).showSnackBar(
              ...
              child: Row(
                children: [
                  Container(
                    ...
                    child: Text(
                      '${todoCardsList.length} ${todoCardsList.length == 1 ? 'Todo' : 'Todos'}',
            ...
            child: todoCardsList.isEmpty
                ...
                : ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      TodoModel todo = todoCardsList[index];
